...
public class NamesServer extends AppCompatActivity implements View.OnClickListener {
     ...
     * */
    public static final String URL_SAVE_NAME = "https://192.168.0.108/SqliteSync/saveName.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_names_server);
